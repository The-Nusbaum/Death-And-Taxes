...
class CountiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create county" do
    assert_difference('County.count') do
      post counties_url, params: { county: { markup: @county.markup, name: @county.name, tax_rate: @county.tax_rate } }
    end
  ...
  test "should update county" do
    patch county_url(@county), params: { county: { markup: @county.markup, name: @county.name, tax_rate: @county.tax_rate } }
